...
if __name__ == "__main__":
    ...
    for model_name in config['models']:
        ...
        #------------------------------
        # WE DO NOT LOG VCDM MAPS
        #------------------------------
        
        # Add model identifier to cosmo_params (optional, for debugging)
        # model_id = np.full((cosmo_params.shape[0], 1), config['models'].index(model_name))
        # cosmo_params = np.hstack([cosmo_params, model_id])
