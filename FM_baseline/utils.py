...
class AstroMapDataset(Dataset):
    ...
    #     target_map = self.target_maps[idx].unsqueeze(0)  # Shape: (1, H, W)
    #     vcdm_map = self.vcdm_maps[idx].unsqueeze(0)  # Shape: (1, H, W)
    ...
    #         torch.manual_seed(seed)
    #         vcdm_map = self.transform(vcdm_map)
        
    #     return total_mass, target_map, vcdm_map, astro_param
